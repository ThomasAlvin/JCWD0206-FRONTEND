 ...
 return (
  <>
   ...
   <div className="flex" style={{ justifyContent: 'center' }}>
    ...
    >
     ...
     >
      ...
      >
       Selengkapnya tentang mobil anda
      </div>
      <div
       className="flex"
       style={{
     ...
     <div className="tentang">
      {/* <i
       className="fa fa-angle-left flex"
       style={{
        border: '1px solid black',
        padding: '5px',
        // position: 'absolute',
      ...
      /> */}
      <div
       className="products overflowX"
       style={{ flexWrap: 'nowrap', border: '20px solid #ebeeef' }}
      >
       {selengkapnya.map((val, idx) => (
        <Card key={'product_' + idx} {...val} number={idx + 1} />
       ))}
      </div>
      {/* <i
       className="fa fa-angle-right flex"
       style={{
        border: '1px solid black',
        padding: '5px',
        // position: 'absolute',
   ...
   >
    ...
    <div className="flex" style={{ justifyContent: 'center', padding: '30px' }}>
     <div
      style={{
       padding: '10px',
 ...
 return (
  <div className="card">
   ...
   <div
    ...
    style={props.number > 4 ? { border: '0px' } : null}
   >
